...
public class GameClient extends JFrame {
    ...
    public GameClient(String ip, String stubID, String name) {
        ...
        /**
         * MATTS CODE THE LEGEND LIVES ON DO NOT DELETE EVEN THOUGH IT IS NOT USED
         * THANKS, LUCAS String[] optionsName = { "OK" }; JPanel panelName = new
         * JPanel(); JLabel lblName = new JLabel("Enter your unique nickname: ");
        ...
        try {
            ...
            do {
                ...
                JOptionPane.showOptionDialog(null, panelName, "Nickname", JOptionPane.NO_OPTION,
                        JOptionPane.QUESTION_MESSAGE, null, optionsName, optionsName[0]);
        ...
        // Getting the number of cards a player has
        // Dealing out the inital cards
        try {
            stub.addPlayerCards(nickname, stub.dealCards(5));
        } catch (RemoteException re) {
        }
